...
#define MAXX           200     // max screen horizontal pos
...
*/
typedef enum {
    SCR_BLACK, SCR_RED, SCR_GREEN, SCR_BROWN, SCR_BLUE, SCR_MAGENTA, SCR_CYAN, SCR_LIGHTGRAY,
    SCR_DARKGRAY, SCR_LIGHTRED, SCR_LIGHTGREEN, SCR_YELLOW, SCR_LIGHTBLUE,
    SCR_LIGHTMAGENTA, SCR_LIGHTCYAN, SCR_WHITE
} ScreenColor;
